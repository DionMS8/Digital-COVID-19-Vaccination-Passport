...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="title">CITIZENS</div><br>
      ...
      <div class="content">
          ...
          <p class="form-heading"></p>
            ...
            <table>
              ...
              $sql = "SELECT citizen_fname, citizen_lname, citizen_email, citizen_phnum, citizen_dob, citizen_address FROM citizens";
              ...
              if ($result->num_rows > 0) {
                ...
                echo "<tr><td>" . $row["citizen_fname"] . "</td><td>"
                . $row["citizen_lname"] . "</td><td>" . $row["citizen_email"] . "</td><td>" . $row["citizen_phnum"] . "</td><td>"
                . $row["citizen_dob"] . "</td><td>" . $row["citizen_address"] . "</td></tr>";
                }

                echo "</table>";

              } else { echo "There are no citizens registered right now."; }
