...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="title">AUTHORIZED INQUIRERS</div><br>
      ...
      <div class="content">
          ...
          <p class="form-heading"></p>
            ...
            <table>
              ...
              $sql = "SELECT inquirer_fname, inquirer_lname, company_name, company_address, inquirer_email, inquirer_phnum, inquirer_dob FROM inquirers";
              ...
              if ($result->num_rows > 0) {
                ...
                echo "<tr><td>" . $row["inquirer_fname"] . "</td><td>"
                . $row["inquirer_lname"] . "</td><td>" . $row["company_name"] . "</td><td>" . $row["company_address"] . "</td><td>"
                . $row["inquirer_email"] . "</td><td>" . $row["inquirer_phnum"] . "</td><td>" . $row["inquirer_dob"] . "</td></tr>";
                }
