...
$query = "INSERT INTO vax_info (`citizen_fname`, `citizen_lname`, `citizen_address`, 
`citizen_dob`, `vax_status`, `vax_site`, `num_doses`, `vax_type1`, `vax_date1`, 
`batch_num1`, `vax_admin1`, `vax_type2`, `vax_date2`, `batch_num2`, `vax_admin2`, 
`vax_type3`, `vax_date3`, `batch_num3`, `vax_admin3`) VALUES ('$citizenFname', 
'$citizenLname', '$citizenAddress', '$citizenDob', '$vaxStatus', '$vaxSite', 
'$numDoses', '$vaxType1', '$vaxDate1', '$batchNum1', '$vaxAdmin1', '$vaxType2', 
'$vaxDate2', '$batchNum2', '$vaxAdmin2', '$vaxType3', '$vaxDate3', '$batchNum3', 
'$vaxAdmin3')"; 
        ...
        $query = "INSERT INTO vax_info (`citizen_fname`, `citizen_lname`, `citizen_address`, 
        `citizen_dob`, `vax_status`, `vax_site`, `num_doses`, `vax_type1`, `vax_date1`, 
        `batch_num1`, `vax_admin1`) VALUES ('$citizenFname','$citizenLname', '$citizenAddress', 
        '$citizenDob', '$vaxStatus', '$vaxSite','$numDoses', '$vaxType1', '$vaxDate1', 
        '$batchNum1', '$vaxAdmin1')"; 
