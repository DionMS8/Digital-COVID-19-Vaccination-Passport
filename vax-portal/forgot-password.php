...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM vax_admin WHERE vaxadmin_email='{$email}'")) > 0) {
        $query = mysqli_query($conn, "UPDATE vax_admin SET code='{$code}' WHERE vaxadmin_email='{$email}'");
