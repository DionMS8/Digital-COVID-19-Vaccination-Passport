<?php
    ...
    if (isset($_SESSION['SESSION_EMAIL'])) {
        header("Location: ./vax-info/vax-info.php");
        die();
    }
    ...
    if (isset($_GET['verification'])) {
        if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM vax_admin WHERE code='{$_GET['verification']}'")) > 0) {
            $query = mysqli_query($conn, "UPDATE vax_admin SET code='' WHERE code='{$_GET['verification']}'");
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM vax_admin WHERE vaxadmin_email='{$email}' AND password='{$password}'";
...
<head>
    ...
    <title> Vaccine Administrator Login | CoVaxPassTT </title>
            ...
            <div class="workinghny-form-grid">
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <b><h3>VACCINE ADMINISTRATOR PORTAL</h3></b><br>
