...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM inquirers WHERE inquirer_email='{$email}'")) > 0) {
        $query = mysqli_query($conn, "UPDATE inquirers SET code='{$code}' WHERE inquirer_email='{$email}'");
